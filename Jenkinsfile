#!groovy
withEnv(['channel=D0457H2086Q','NEXUS_PASSWORD = credentials("nexus-password")']) {
            ...
            stage("Inicio"){
                    ...
                    node {
                        ...
                        checkout(
                                    ...
                                    userRemoteConfigs: [[url: 'https://github.com/ldominguez1986/ms-iclab.git']]])
                    }
            }
            stage("CI 1: Compliar"){
                ...
                stage("CD 2: Descargar Nexus"){
                    ...
                    node {
                           ...
                           //  sh "sleep 20 && curl -X GET -u admin:${env.NEXUS_PASSWORD} http://nexus:8081/repository/repository_grupo2/com/devopsusach2020/DevOpsUsach2020/${VERSION}/DevOpsUsach2020-${VERSION}.jar -O"
                            sh "sleep 20 && curl -X GET http://nexus:8081/repository/repository_grupo2/com/devopsusach2020/DevOpsUsach2020/${VERSION}/DevOpsUsach2020-${VERSION}.jar -O"
                        }
                }
